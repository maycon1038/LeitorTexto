...
public class GraphicOverlay extends View {
  ...
  /**
   * Define as informações de origem da imagem sendo processada pelos detectores, incluindo tamanho e
   * se é invertido, o que informa como transformar as coordenadas da imagem mais tarde.
   *
   * @param imageWidth a largura da imagem enviada aos detectores do kit de ML
   * @param imageHeight a altura da imagem enviada aos detectores do kit de ML
   * @param isFlipped se a imagem é invertida. Deve defini-lo como verdadeiro quando a imagem for do
   *     front camera.
   */
